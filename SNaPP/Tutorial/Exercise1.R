...
c("Jaime", "Meg", "Meredith, Xiao, Ana, Taylor, Wen, Drew, Zach, Brian, Paul, Keenan, Ethan, Scott, Daniel, Rob, Doug, Greg, Ira, Chris)
...
members <- c("Jaime", "Meg", "Meredith", "Xiao", "Ana", "Taylor", "Wen", "Drew", "Zach", "Brian", "Paul", "Keenan", "Ethan", "Scott", "Daniel", "Rob", "Doug", "Greg", "Ira", "Chris")
...
gender <- rep(c("female", "male"), c(7, 13))
...
year <- c(13,11,14,12,13,NA, 15, 16, 11, 10, 11, 11, 12, 13, NA, 11, 12, 14, 18, 19)
bdaymonth <- c(7,8,6,5,4,3,7,8,9,9,10,11,12,4,3,11, 10, 8, 9, 10)
