## Canned Data Report
##### Edward Hernández
I'm going to complete the canned data report assignment from Fall 2014 to brush up on my R skills.

Obviously, let's read in some data.
```{r}
...
#### How many subjects were in each of the four conditions of the experiment?
...
table(mturk.stress$treatmentgroup)
```
